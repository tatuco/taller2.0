...
class PermissionsController extends Controller
{
    ...
    public function store(StorePermissionRequest $request)
    {
        ...
        AuditController::store('Permiso', 'Creando permiso con id: '.$permission->id);
    ...
    public function update(UpdatePermissionRequest $request, Permission $permission)
    {
        ...
        AuditController::store('Permiso', 'Actualizando permiso con id: '.$permission->id);
    ...
    public function destroy(Permission $permission)
    {
        ...
        $permission->delete();
        AuditController::store('Permiso', 'Eliminando permiso con id: '.$permission->id);
